    ...
    <section className="flex flex-col gap-4 rounded-3xl border border-line bg-card p-5 shadow-sm">
      ...
      {previewUrl ? (
        <div className="flex justify-center">
          <div className="relative w-full max-w-[240px] overflow-hidden bg-[#1f1a17]/6 shadow-sm">
            <img
              src={previewUrl}
              alt=""
              className="max-h-[320px] w-full object-contain [filter:saturate(1.08)_contrast(1.04)_brightness(1.03)_sepia(0.01)_hue-rotate(-4deg)_blur(0.22px)]"
            />
            <div
              aria-hidden="true"
              ...
              style={{
                background:
                  "radial-gradient(circle at 7% 18%, rgba(255, 166, 84, 0.38), transparent 30%), radial-gradient(circle at 94% 78%, rgba(255, 92, 62, 0.24), transparent 32%), linear-gradient(135deg, rgba(255, 188, 96, 0.14), transparent 38%, transparent 60%, rgba(255, 112, 70, 0.1))"
              }}
            />
          </div>
        </div>
